...
class orderHelperClass():
    def createOrder(self, request):
        ...
        for oneCartItem in cart_serializer_data:
            print(oneCartItem['product_weight'], "oneCartItem")
            ...
            print(product_weight_obj.price)
            ...
            cartItemPrice = float(product_weight_obj.price - product_weight_obj.discount_price)
