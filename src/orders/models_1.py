...
class OrderProductDetail(TimeStampMixin):
    ...
    def save(self, *args, **kwargs):
        ...
        self.price = (decimal.Decimal(self.product.price) - decimal.Decimal(self.product.discount_price))
        # self.total_price = self.quantity * self.product.price

        total_amt = self.quantity * (decimal.Decimal(self.product.price) - decimal.Decimal(self.product.discount_price))
