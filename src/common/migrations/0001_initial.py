# Generated by Django 3.2.11 on 2022-06-01 12:46
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mobile', phonenumber_field.modelfields.PhoneNumberField(max_length=15, region=None, unique=True, verbose_name='Mobile number')),
                ('is_active', models.BooleanField(default=True)),
                ('is_admin', models.BooleanField(default=False)),
                ('is_new_user', models.BooleanField(default=True)),
                ('date_joined', models.DateTimeField(auto_now_add=True, verbose_name='date joined')),
                ('role', models.CharField(choices=[('super_admin', 'super_Admin'), ('admin', 'admin'), ('vendor', 'Vendor'), ('executive_user', 'Executive_User'), ('user', 'User')], default='user', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role', models.CharField(choices=[('super_admin', 'super_Admin'), ('admin', 'admin'), ('vendor', 'Vendor'), ('executive_user', 'Executive_User'), ('user', 'User')], default='user', max_length=50, null=True)),
